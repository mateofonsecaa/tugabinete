...
const TUTORIALS = [
  ...
  },
  {
    ...
    summary: "Encontrá pacientes rápido usando el buscador y filtros disponibles.",
    duration: "0:50",
    videoUrl: "/videos/ayuda/buscar-pacientes.mp4",
    links: [{ label: "Ir a Pacientes", href: "/patients" }],
    steps: [
      "Abrí Pacientes.",
      "Escribí nombre/apellido en el buscador.",
      "Entrá al paciente desde el resultado.",
    ],
  },
  {
