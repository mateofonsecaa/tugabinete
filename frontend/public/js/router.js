...
import { PatientDetails, initPatientDetails } from "./features/patients/patient-details.view.js";
import { PatientEdit, initPatientEdit } from "./features/patients/patient-edit.view.js";
...
import { HelpPage, initHelpPage } from "./views/help.page.js";
...
export function router() {
  ...
  if (patientEditMatch) {
    if (!requireAuth()) return;
    document.body.classList.add("is-patient-edit");
